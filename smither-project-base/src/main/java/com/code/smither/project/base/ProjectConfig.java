...
public class ProjectConfig extends EngineConfig implements FilterConfig, TableFilterConfig {
    ...
    protected String columnCreate = "create_time,create_date,create_at,created_at,created_date";
    protected String columnUpdate = "update_time,update_date,update_at,updated_at,modified_date,modify_time";
    ...
    protected String columnHideForTables = "*avatar,*headUrl,content,description,address,update_time,update_date,update_at,updated_at,modified_date,modify_time,create_time,create_date,create_at,created_at,created_date";
