...
//        return '"' + name.toUpperCase() + '"';
    ...
    protected ResultSet queryTables() throws SQLException {
        return databaseMetaData.getTables(null, dbFactory.getUser(), "%", new String[] { "TABLE" });
    }

    @Override
    protected ResultSet queryColumns(String tableName) throws SQLException {
        return databaseMetaData.getColumns(null, dbFactory.getUser(), tableName, "%");
    }

    @Override
    protected ResultSet queryPrimaryKeys(String tableName) throws SQLException {
        return databaseMetaData.getPrimaryKeys(null, dbFactory.getUser(), tableName);
    }
}
