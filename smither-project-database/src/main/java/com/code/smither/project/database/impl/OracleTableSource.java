...
//            ResultSet catalogSet = databaseMetaData.getCatalogs();
//            ResultSetMetaData setMetaData = catalogSet.getMetaData();
//            for (int i = 1; i <= setMetaData.getColumnCount(); i++) {
//                System.out.println("ColumnName:" + setMetaData.getColumnName(i) + " " + "ColumnTypeName:" + setMetaData.getColumnTypeName(i));
//                System.out.println("isReadOnly:" + setMetaData.isReadOnly(i) + "  isWriteable:" + setMetaData.isWritable(i) + "  isNullable:" + setMetaData.isNullable(i));
//                System.out.println("tableName:" + setMetaData.getTableName(i));
//            }
//            while (catalogSet.next()) {
//                for (int i = 1; i <= setMetaData.getColumnCount(); i++) {
//                    System.out.print(setMetaData.getColumnName(i) + ":" + catalogSet.getString(i) + "\t");
//                }
//                System.out.println();
//            }
            ResultSet tableResult = databaseMetaData.getTables(null, dbFactory.getUser(), "%", new String[] { "TABLE" });
    ...
    protected List<Table> buildTables(ResultSet tableResult) throws SQLException {
        ...
        while (tableResult.next()) {
            ...
            System.out.println("构建表【"+table.getNameSQL()+"】开始（" + tables.size() + "）");
            ...
            tables.add(table);
            System.out.println("构建表【"+table.getNameSQL()+"】模型完成（" + tables.size() + "）");
        }
        tableResult.close();
        return tables;
    }
    ...
    protected List<TableColumn> buildColumns(String tableName) throws SQLException {
        ResultSet resultSet = databaseMetaData.getColumns(null, dbFactory.getUser(), tableName, "%");
...
//            column.setAutoIncrement(Boolean.valueOf(true).equals(is_autoincrement) || "YES".equalsIgnoreCase(is_autoincrement + "") || Integer.valueOf("1").equals(is_autoincrement));
            ...
            columns.add(column);
            System.out.println("构建列【" + tableName + "】【" + column.getNameSQL() + "】模型完成（" + columns.size() + "）");
        }
        return columns;
    }
